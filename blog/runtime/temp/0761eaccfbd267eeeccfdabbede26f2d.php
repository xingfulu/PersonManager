<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\xampp\htdocs\blog\public/../application/admin\view\eat\update1.html";i:1497946881;s:63:"C:\xampp\htdocs\blog\public/../application/admin\view\base.html";i:1497936327;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                ...
                <li class="active">
                    <a href="<?php echo url('update1'); ?>">编辑午餐</a>
                </li>

            </ol>
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('eat'); ?>">饮食计划</a></li>
                <li class="active"><a href="<?php echo url('update1'); ?>">编辑饮食任务</a></li>
            </ul>
            <form class="form-horizontal" id="form" action="" method="post">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">午餐编辑处</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">午餐</label>
                            <div class="col-sm-9">
                                <input type="text" name="lunch_food"  class="form-control" placeholder="" value="<?php echo $oldDate['lunch_food']; ?>">
                            </div>
                        </div>            
                    </div>
                </div>
