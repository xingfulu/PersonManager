<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\xampp\htdocs\blog\public/../application/admin\view\live\update.html";i:1497863911;s:63:"C:\xampp\htdocs\blog\public/../application/admin\view\base.html";i:1497859089;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
...
<div class="col-sm-10 col-xs-10 col-md-10 col-lg-10 WrapperWhole">
            <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                <li>
                    <a href="<?php echo url('birthday'); ?>"><i class="fa fa-cogs"></i>
                        生活点滴</a>
                </li>
                <li class="active">
                    <a href="<?php echo url('update'); ?>">编辑生日</a>
                </li>

            </ol>
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('birthday'); ?>">生活点滴</a></li>
                <li class="active"><a href="<?php echo url('update'); ?>">编辑生日</a></li>
            </ul>
            <form class="form-horizontal" id="form" action="" method="post">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">生日编辑处</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">姓名：</label>
                            <div class="col-sm-9">
                                <input type="text" name="birthday_name"  class="form-control" placeholder="" value="<?php echo $oldDate['birthday_name']; ?>">
                            </div>
                        </div>            
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">生日：</label>
                            <div class="col-sm-9">
                                <input type="text" name="birthday_day"  class="form-control" placeholder="" value="<?php echo $oldDate['birthday_day']; ?>">
                            </div>
                        </div>
                    </div>
                </div>
