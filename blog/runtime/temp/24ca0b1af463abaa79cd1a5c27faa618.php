<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"C:\xampp\htdocs\blog\public/../application/admin\view\show\add.html";i:1498142747;s:63:"C:\xampp\htdocs\blog\public/../application/admin\view\base.html";i:1498183363;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
...
<div class="col-sm-10 col-xs-10 col-md-10 col-lg-10 WrapperWhole">
 <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                ...
                <li class="active">
                    <a href="<?php echo url('add'); ?>">添加作品</a>
                </li>

            </ol>
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('show'); ?>">作品集</a></li>
                <li class="active"><a href="<?php echo url('add'); ?>">添加作品</a></li>
            </ul>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="show_head"  class="form-control" placeholder="">
                            </div>
                        </div>            
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">作品内容</label>
                            <div class="col-sm-9">
                                <input type="text" name="show_content"  class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">作品链接</label>
                            <div class="col-sm-9">
                                <input type="text" name="show_address"  class="form-control" placeholder="">
                            </div>
                        </div>
                    </div>
                </div>
