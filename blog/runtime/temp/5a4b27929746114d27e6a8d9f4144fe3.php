<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"C:\xampp\htdocs\blog\public/../application/admin\view\gym\add.html";i:1497929157;s:63:"C:\xampp\htdocs\blog\public/../application/admin\view\base.html";i:1497927825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
            ...
            <form class="form-horizontal" id="form" action="" method="post">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">健身任务管理管理</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">健身项目</label>
                            <div class="col-sm-9">
                                <input type="text" name="gym_item"  class="form-control" placeholder="">
                            </div>
                        </div>            
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">进行时间</label>
                            <div class="col-sm-9">
                                <input type="text" name="gym_time"  class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">到达效果</label>
                            <div class="col-sm-9">
                                <input type="text" name="gym_result"  class="form-control" placeholder="">
                            </div>
                        </div>
                    </div>
                </div>
