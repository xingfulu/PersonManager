<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\xampp\htdocs\blog\public/../application/admin\view\camera\add.html";i:1498207746;s:63:"C:\xampp\htdocs\blog\public/../application/admin\view\base.html";i:1498183363;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
...
<div class="col-sm-10 col-xs-10 col-md-10 col-lg-10 WrapperWhole">
            <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                ...
                <li class="active">
                    <a href="<?php echo url('add'); ?>">添加相片</a>
                </li>

            </ol>
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('birthday'); ?>">生活点滴</a></li>
                <li class="active"><a href="<?php echo url('add'); ?>">添加相片</a></li>
            </ul>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">相片：</label>
                            <div class="col-sm-9">
                                <input type="file" name="photo_pic" >
                            </div>
                        </div>            
                    </div>
                </div>
