<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"C:\xampp\htdocs\blog\public/../application/admin\view\article\store.html";i:1497841600;s:63:"C:\xampp\htdocs\blog\public/../application/admin\view\base.html";i:1498572755;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
...
<div class="col-sm-10 col-xs-10 col-md-10 col-lg-10 WrapperWhole">
    <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
        ...
        <li class="active">
            <a href="<?php echo url('store'); ?>">文章添加</a>
        </li>
    </ol>
    <ul class="nav nav-tabs" role="tablist">
        <li><a href="<?php echo url('index'); ?>">文章管理</a></li>
        <li class="active"><a href="<?php echo url('store'); ?>">文章添加</a></li>
    </ul>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"   class="form-control" placeholder="文章标题" name="arc_title">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"   class="form-control" placeholder="文章链接" name="arc_address">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">文章摘要</label>
                    <div class="col-sm-9">
                        <textarea type="text"   class="form-control" placeholder="文章摘要" name="arc_digest"></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="littlePic">
                <input type="file" class="" name="arc_thumb" value="文章缩略图">
                </div>
            </div>
        </div>
