<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"C:\xampp\htdocs\blog\public/../application/admin\view\family\edit.html";i:1497626240;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input value="<?php echo $oldDate['famlily_name']; ?>" type="text" name="famlily_name"  class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">与本人关系</label>
                            <div class="col-sm-9">
                                <input value="<?php echo $oldDate['famlily_relation']; ?>" type="text" name="famlily_relation"  class="form-control" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input value="<?php echo $oldDate['famlily_job']; ?>" type="text" name="famlily_job"  class="form-control" placeholder="">
                            </div>
                        </div>
                    </div>
                </div>
