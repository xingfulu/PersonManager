<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\xampp\htdocs\blog\public/../application/admin\view\note\update.html";i:1498095109;s:63:"C:\xampp\htdocs\blog\public/../application/admin\view\base.html";i:1498572755;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                ...
                <li class="active">
                    <a href="<?php echo url('update'); ?>">编辑记事本</a>
                </li>

            </ol>
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('note'); ?>">记事本</a></li>
                <li class="active"><a href="<?php echo url('update'); ?>">编辑记事本</a></li>
            </ul>
            <form class="form-horizontal" id="form" action="" method="post">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">记事本编辑处</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">风格图片</label>
                            <div class="col-sm-9">
                                <input type="file" name="note_pic" >
                            </div>
                        </div>    
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">记录标题</label>
                            <div class="col-sm-9">
                                <input type="text" id="exampleInputFile" name="note_head" value="<?php echo $oldDate['note_head']; ?>">
                            </div>
                        </div>   
                        
                        <div class="form-group">
                    <label for=""  class="col-sm-2 control-label">记录点滴</label>
                    <div class="col-sm-9">
                        <textarea id="container" name="note_content" style="height:300px;width:100%;"
                        >
                            <?php echo $oldDate['note_content']; ?>
                        </textarea>
                        <script>
