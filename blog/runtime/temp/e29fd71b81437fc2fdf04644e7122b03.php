<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\xampp\htdocs\blog\public/../application/admin\view\gym\update.html";i:1497929453;s:63:"C:\xampp\htdocs\blog\public/../application/admin\view\base.html";i:1497927825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
...
<div class="col-sm-10 col-xs-10 col-md-10 col-lg-10 WrapperWhole">
            <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                <li>
                    <a href="<?php echo url('gym'); ?>"><i class="fa fa-cogs"></i>
                        健身计划</a>
                </li>
                <li class="active">
                    <a href="<?php echo url('update'); ?>">编辑健身任务</a>
                </li>

            </ol>
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('gym'); ?>">健身计划</a></li>
                <li class="active"><a href="<?php echo url('update'); ?>">编辑健身任务</a></li>
            </ul>
            <form class="form-horizontal" id="form" action="" method="post">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">健身任务编辑处</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">健身项目</label>
                            <div class="col-sm-9">
                                <input type="text" name="gym_item"  class="form-control" placeholder="" value="<?php echo $oldDate['gym_item']; ?>">
                            </div>
                        </div>            
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">执行时间</label>
                            <div class="col-sm-9">
                                <input type="text" name="gym_time"  class="form-control" placeholder="" value="<?php echo $oldDate['gym_time']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">达到效果</label>
                            <div class="col-sm-9">
                                <input type="text" name="gym_result"  class="form-control" placeholder="" value="<?php echo $oldDate['gym_result']; ?>">
                            </div>
                        </div>
                    </div>
                </div>
