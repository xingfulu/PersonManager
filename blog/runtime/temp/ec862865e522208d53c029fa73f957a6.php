<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"C:\xampp\htdocs\blog\public/../application/admin\view\article\recycle.html";i:1497857215;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th>文章链接</th>
                    <th>添加时间</th>
                    <th colspan="2" style="text-indent: 90px;">操作</th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $vo['arc_address']; ?></td>
                    <td><?php echo $vo['sendtime']; ?></td>
                    <td>
                        <button class="btn btn-primary btn-xs ">
                                <a href="<?php echo url('outRecycle',['arc_id'=>$vo['arc_id']]); ?>">恢复数据</a>
                        </button>
                        </td>
                        <td>
                            <button class="btn btn-danger btn-xs ">
                                <a href="javascript:;" onclick="del(<?php echo $vo['arc_id']; ?>)">彻底删除</a>
                            </button>
                        </td>
                </tr>
