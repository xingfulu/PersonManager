<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"C:\xampp\htdocs\blog\public/../application/admin\view\book\update1.html";i:1498023939;s:63:"C:\xampp\htdocs\blog\public/../application/admin\view\base.html";i:1498012978;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                ...
                <li class="active">
                    <a href="<?php echo url('update1'); ?>">编辑互联网读书计划</a>
                </li>

            </ol>
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('book'); ?>">读书计划</a></li>
                <li class="active"><a href="<?php echo url('update1'); ?>">编辑互联网读书任务</a></li>
            </ul>
            <form class="form-horizontal" id="form" action="" method="post">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">互联网编辑处</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">书目</label>
                            <div class="col-sm-9">
                                <input type="text" name="internet_content"  class="form-control" placeholder="" value="<?php echo $oldDate['internet_content']; ?>">
                            </div>
                        </div>    
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">书目图片</label>
                            <div class="col-sm-9">
                                <input type="file" id="exampleInputFile" name="internet_img" >
                            </div>
                        </div>   
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">读完时间</label>
                            <div class="col-sm-9">
                                <input type="date" name="internet_time"  class="form-control" placeholder="" value="<?php echo $oldDate['internet_time']; ?>">
                            </div>
                        </div> 
                        <div class="form-group">
                    <label for=""  class="col-sm-2 control-label">文章内容</label>
                    <div class="col-sm-9">
                        <textarea id="container" name="internet_show" style="height:300px;width:100%;"
                        >
