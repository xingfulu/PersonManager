<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"C:\xampp\htdocs\blog\public/../application/admin\view\live\add.html";i:1497861756;s:63:"C:\xampp\htdocs\blog\public/../application/admin\view\base.html";i:1497859089;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>后台管理页面</title>
...
<div class="col-sm-10 col-xs-10 col-md-10 col-lg-10 WrapperWhole">
            <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                ...
                <li class="active">
                    <a href="<?php echo url('add'); ?>">添加生日</a>
                </li>

            </ol>
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('birthday'); ?>">生活点滴</a></li>
                <li class="active"><a href="<?php echo url('birthday'); ?>">添加生日</a></li>
            </ul>
            <form class="form-horizontal" id="form" action="" method="post">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">生日记录管理</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">姓名：</label>
                            <div class="col-sm-9">
                                <input type="text" name="birthday_name"  class="form-control" placeholder="">
                            </div>
                        </div>            
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">生日：</label>
                            <div class="col-sm-9">
                                <input type="text" name="birthday_day"  class="form-control" placeholder="">
                            </div>
                        </div>
                    </div>
                </div>
